...
try {
		Debug.PushSubsStack("Activity_Create (actlupakatasandi) ","actlupakatasandi",3,actlupakatasandi.mostCurrent.activityBA,actlupakatasandi.mostCurrent,18);
...
Debug.ShouldStop(131072);
 BA.debugLineNum = 20;BA.debugLine="Activity.LoadLayout(\"LupaKataSandi\")";
...
try {
		Debug.PushSubsStack("Activity_Pause (actlupakatasandi) ","actlupakatasandi",3,actlupakatasandi.mostCurrent.activityBA,actlupakatasandi.mostCurrent,28);
...
try {
		Debug.PushSubsStack("Activity_Resume (actlupakatasandi) ","actlupakatasandi",3,actlupakatasandi.mostCurrent.activityBA,actlupakatasandi.mostCurrent,24);
